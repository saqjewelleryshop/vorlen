...
export const projects = [
  ...
  { slug: 'tenant-dashboard', number: '05', client: 'ZOCHAT', type: 'AI Customer Service / SaaS / Automation', title: 'AI customer service that works 24/7.', tone: 'silver', summary: 'A multi-tenant AI customer service platform that lets businesses deploy a branded support assistant to their website — answering customer questions, capturing leads, creating support tickets and connecting with existing business tools.', externalUrl: 'https://dashboard-kappa-flax-30.vercel.app/' },
